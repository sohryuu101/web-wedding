...
export function QuotesSection() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold text-gray-900">Kutipan Ayat</h2>
        <p className="text-gray-600 mt-2">Tambahkan kutipan ayat yang bermakna ke undangan Anda</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Kutipan yang akan ditampilkan secara menonjol</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            <Label>Pilih Kutipan</Label>
